...
# Ensure modules directory exists (runs on import for Gunicorn)
...
if os.path.exists(MODULES_DIR):
    ...
    if module_count == 0:
        ...
        logging.warning(f"⚠️  WARNING: Expected 20 modules, found {module_count}")
    else:
        logging.info("✅ All 20 modules loaded successfully")
else:
...
if __name__ == '__main__':
    # Only for local development - Railway uses Gunicorn via Procfile
    logging.info("Running in local development mode (not Gunicorn)")
